...
# Franz installation
# ----------------------------------
echo "${LIGHTGREEN}[15/34] Installing Franz 💬'${NOCOLOR}"
...
# Hyper installation
# ----------------------------------
echo "${LIGHTGREEN}[16/34] Installing Hyper${NOCOLOR}"
...
# Docker installation
# ----------------------------------
echo "${LIGHTGREEN}[17/34] Installing Docker 🐳'${NOCOLOR}"
...
# ----------------------------------
echo "${LIGHTGREEN}[18/34] Installing docker-compose 🍱'${NOCOLOR}"
...
# ----------------------------------
echo "${LIGHTGREEN}[19/34] Installing kubectl ⏹${NOCOLOR}"
curl -LO https://storage.googleapis.com/kubernetes-release/release/`curl -s https://storage.googleapis.com/kubernetes-release/release/stable.txt`/bin/linux/amd64/kubectl

# ----------------------------------
# Heroku CLI installation
# ----------------------------------
echo "${LIGHTGREEN}[20/34] Installing heroku-cli 💜${NOCOLOR}"
...
# ----------------------------------
echo "${LIGHTGREEN}[21/34] Installing aws-cli 💛'${NOCOLOR}"
...
# Fzf installation
# ----------------------------------
echo "${LIGHTGREEN}[22/34] Installing fzf 🔎${NOCOLOR}"
...
# ----------------------------------
echo "${LIGHTGREEN}[23/34] Installing dbeaver ⌛${NOCOLOR}"
...
# Robo3t installation
# ----------------------------------
echo "${LIGHTGREEN}[24/34] Installing Robo3t 💚${NOCOLOR}"
...
# ----------------------------------
echo "${LIGHTGREEN}[25/34] Installing Insomnia 🎱'${NOCOLOR}"
...
# ----------------------------------
echo "${LIGHTGREEN}[26/34] Installing Postbird 🐘${NOCOLOR}"
...
# VLC installation
# ----------------------------------
echo "${LIGHTGREEN}[27/34] Installing VLC ⏯${NOCOLOR}"
...
# ----------------------------------
echo "${LIGHTGREEN}[28/34] Installing Transmission 📩${NOCOLOR}"
...
# GIMP installation
# ----------------------------------
echo "${LIGHTGREEN}[29/34] Installing GIMP 🖼${NOCOLOR}"
...
# ----------------------------------
echo "${LIGHTGREEN}[30/34] Installing Reactotron ⚛${NOCOLOR}"
...
# ----------------------------------
echo "${LIGHTGREEN}[31/34] Installing Discord 💬${NOCOLOR}"
...
# ----------------------------------
echo "${LIGHTGREEN}[32/34] Installing Terminalizer 💅${NOCOLOR}"
...
# ----------------------------------
echo "${LIGHTGREEN}[33/34] Installing Expo 📱${NOCOLOR}"
npm install -g terminalizer
clear
...
# Expo CLI installation
# ----------------------------------
echo "${LIGHTGREEN}[34/34] Installing Vercel CLI 📱${NOCOLOR}"
